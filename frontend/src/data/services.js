...
export const services = [
  ...
  },
  {
    ...
    teaser:
      "Regelmäßige Pflege von Grünflächen und Außenanlagen – abgestimmt auf den Bedarf.",
    description: [
  ...
  },
  {
    ...
    teaser:
      "Schnee- und Eisbeseitigung sowie Streudienst auf Wegen, Zufahrten und Außenflächen.",
    description: [
...
export const furtherServices = [
  "Hausmeisterdienste",
  "Terrassen- & Außenflächenreinigung",
];
